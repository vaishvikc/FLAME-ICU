#!/usr/bin/env python3
"""
Neural Network Hyperparameter Optimization for FLAME-ICU Approach 2: Transfer Learning

This script uses Optuna to find optimal Neural Network parameters for transfer learning
that balance discrimination (AUC) and calibration quality (ECE, Brier score).

The optimization explores different architectures, regularization strategies,
and loss functions to find the best configuration for clinical decision-making in transfer learning context.
"""
...
sys.path.insert(0, os.path.join(code_dir, 'approach1_cross_site'))
...
def main():
    ...
    print("=" * 80)
    print("FLAME-ICU Approach 2: Neural Network Hyperparameter Optimization (Transfer Learning)")
    print("=" * 80)
    ...
    print(f"Use the saved parameters to update approach_2_config.json")
