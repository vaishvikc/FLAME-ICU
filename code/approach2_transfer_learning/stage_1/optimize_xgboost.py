#!/usr/bin/env python3
"""
XGBoost Hyperparameter Optimization for FLAME-ICU Approach 2: Transfer Learning

This script uses Optuna to find optimal XGBoost parameters for transfer learning
...
probability estimates suitable for clinical decision-making in transfer learning context.
"""
...
def main():
    ...
    print("=" * 80)
    print("FLAME-ICU Approach 2: XGBoost Hyperparameter Optimization (Transfer Learning)")
    print("=" * 80)
